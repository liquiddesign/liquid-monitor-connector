...
class LiquidMonitorLogger extends Logger
{
	...
	public function __construct(protected Request $request, protected LiquidMonitorConnector $liquidMonitorConnector, protected RequestFactory $requestFactory, private readonly User $user)
	{
	...
	{
		$this->liquidMonitorConnector->log([
			'title' => $this->title,
			...
			'code' => (string) $code,
			'weak' => $weak,
			'job_id' => $this->liquidMonitorConnector->getJobId(),
